...
- Decision: canonical spec is `docs/spec.v0.5.1.md` with front matter version `0.5.1`.
...
As of 2026-02-09, unresolved blocker count is 0.
...
Determinism status: `READY_FOR_BUILD` (effective 2026-02-09).
